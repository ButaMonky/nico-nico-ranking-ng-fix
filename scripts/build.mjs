...
export const sourceParts = ['src/legacy/prefix.js', 'src/core/events.js', 'src/core/storage.js', 'src/core/config.js', 'src/data/thumb-info-source.js', 'src/legacy/before-ng.js', 'src/ng/logic-rules.js', 'src/legacy/movie-models.js', 'src/legacy/thumb-info-listener.js', 'src/ui/view-state.js', 'src/ui/settings-dialog.js', 'src/services/theme.js', 'src/nico/page-adapter.js', 'src/nico/list-page.js', 'src/nico/search-page.js', 'src/diagnostics/logger.js', 'src/services/new-tab.js', 'src/app/controller.js', 'src/legacy/main-prefix.js', 'src/data/detail-cache.js', 'src/autofill/legacy-controller.js', 'src/nico/navigation.js', 'src/app/bootstrap.js', 'src/app/start.js'];
