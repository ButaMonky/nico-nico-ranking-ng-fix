...
try {
 ...
 assert.equal(s.version,'160.18');assert.equal(s.current.network.run.detail.attempts,0);
 ...
 assert.equal(JSON.parse(report).version,'160.18');assert.doesNotMatch(report,/PRIVATE|sm\d+|https?:|blob:|user_id/);
